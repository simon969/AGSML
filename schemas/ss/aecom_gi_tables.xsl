...
<html>
  <head>
  <title>AGSML <xsl:value-of select="DataStructureAGSML/Hole/HoleId"/></title>
  ...
  function ToggleVisibility(elementID)
{
  ...
  <body>
  <h2>Hole Data <xsl:value-of select="DataStructureAGSML/Hole/HoleId"/> </h2>
  <table>
  <th><button onclick="ToggleVisibility('holeInformation')">holeInformation</button></th>
  <th><button onclick="ToggleVisibility('laboratoryTesting')">LaboratoryTesting</button></th>
   <th><button onclick="ToggleVisibility('monitoring')">monitoring</button></th> 
  <th><button onclick="ToggleVisibility('fieldTesting')">fieldTesting</button></th>
  <th><button onclick="ToggleVisibility('groundInformation')">GroundInformation</button></th>
  </table>
  <xsl:apply-templates/> 
  </body>
  </html>
