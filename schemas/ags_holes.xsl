...
<html>
  ...
  <h2>Ground Investigation Data for Hole <xsl:value-of select="DataStructureAGSML/Hole/HoleId"/> </h2>
  <table>
  <th><h2><a href="#holeInformation" onclick="toggleVisibility('holeInformation')">holeInformation</a></h2></th>
  <th><h2><a href="#laboratoryTesting" onclick="toggleVisibility('laboratoryTesting')">LaboratoryTesting</a></h2></th>
   <th><h2><a href="#monitoring" onclick="toggleVisibility('monitoring')">monitoring</a></h2></th> 
  <th><h2><a href="#fieldTesting" onclick="toggleVisibility('fieldTesting')">fieldTesting</a></h2></th>
  <th><h2><a href="#groundInformation" onclick="toggleVisibility('groundInformation')">GroundInformation</a></h2></th>
  </table>
  <xsl:apply-templates/> 
  </body>
  </html>
...
<h3>In Situ Contaminant and Chemical Testing (Icct)</h3>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates select="Monp/monResults/Icct" />
	</table>
	</xsl:if>
	
<h3>Monitoring Reading (Monr)</h3>
	<xsl:if test="count(Monr)>0">
	<table>
	<th>Exploratory hole or location equivalent ()</th>
	<th>Distance of monitoring point from HOLE_ID (m)</th>
	<th>Monitoring Point identifier ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates select="Monp/monResults/Monr" />
	</table>
	</xsl:if>
...
<xsl:template match="Monp">
	<tr>
		...
		<td><xsl:value-of select="MonpRSCA"/></td>
...
<xsl:template match="Monr">
	<tr>
		...
		<td><xsl:value-of select="MonpID"/></td>
		<td><xsl:value-of select="MonrDateTime"/></td>
		<td></td>
		<td><xsl:value-of select="MonrDstA"/></td>
		<td><xsl:value-of select="MonpDstB"/></td>
		<td><xsl:value-of select="MonpDspA"/></td>
		<td><xsl:value-of select="MonpDspB"/></td>
		<td><xsl:value-of select="MonpDspC"/></td>
		<td><xsl:value-of select="MonpPres"/></td>
		<td><xsl:value-of select="MonpAngA"/></td>
		<td><xsl:value-of select="MonpAngB"/></td>
		<td><xsl:value-of select="MonpAngC"/></td>
		<td><xsl:value-of select="MonpSTRA"/></td>
		<td><xsl:value-of select="MonpStrB"/></td>
		<td><xsl:value-of select="MonpStrC"/></td>
		<td><xsl:value-of select="MonpForc"/></td>
		<td><xsl:value-of select="MonpTemp"/></td>
		<td><xsl:value-of select="MonpWDep"/></td>
