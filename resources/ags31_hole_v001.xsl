...
<html>
  ...
  <body onload="loadSVGL()">
	...
	<xsl:comment>
		content generated by xml stylesheet: ags31_hole_v001
...
<div id ="holeInformation"> 
	...
	<table id="Hole">
		...
		<h3>Project Information (Proj)
			<a>
				<xsl:attribute name="href"><!-- create the href attribute -->
				<xsl:value-of select="$host_view"/><xsl:value-of select="$project"/>
	...
	<h3>Backfill details (Bkfl) 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Bkfl
	...
	<h3>Casing diameter by depth (Cdia)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cdia
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Chiselling details (Chis)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Chis
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Drilling Information (Drem) 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Drem
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Rotary Core Flush Details (Flsh) 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Flsh
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Hole diameter by depth (Hdia)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Hdia
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Depth related hole information (Hdph)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Hdph
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Hole progress by time (Ptim)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Ptim
			</xsl:attribute>All Holes
		</a>
	</h3>
...
<div id ="laboratoryTesting">	
	...
	<h3>California Bearing Test General (Cbrg)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cbrg
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>California Bearing Test (Cbrt)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cbrt
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Chalk Tests (Chlk)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Chlk
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Classification Tests (Clss)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Clss
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Compactions Tests General (Cmpg)</h3>
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cmpg
			</xsl:attribute>All Holes
		</a>
	...
	<h3>Compactions Tests (Cmpt)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cmpt
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Contaminant and Chemical Testing (Cnmt)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cnmt
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Consolidation Test - General (Cong)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cong
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Consolidation Test (Cont)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Cont
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Frost Susceptibility (Frst)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Frst
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Particle Size Distribution Analysis Data (Grad)
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Grad
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Moisture Condition Value (MCV)  Test General (Mcvg)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Mcvg
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Moisture Condition Value (MCV) Test (Mcvt)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Mcvt
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Laboratory Permeability Tests (Ptst)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Ptst
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Relative Density Test (Reld)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Reld
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Rock Sample Tests (Rock)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Rock
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Shear Box Testing - General (Shbg)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Shbg
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Shear Box Testing (Shbt)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Shbt
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Suction Testing (Suct)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Suct
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Ten Per Cent Fines (Tnpc)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Tnpc
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Triaxial Test General (Trig)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Trig
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Triaxial Test (Trix)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Trix
			</xsl:attribute>All Holes
		</a>
	</h3>
...
<div id ="monitoring">
	...
	<h3>Single point instrument installation details (Inst)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Inst
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Single point instrument readings (Iobs)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Iobs
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Monitoring Point (Monp)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Monp
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>In Situ Contaminant and Chemical Testing (Icct)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Icct
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Monitoring Reading (Monr)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Monr
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Piezometer Installation Details (Pref)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Pref
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Piezometer Readings (Pobs)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Pobs
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Profiling Instrument Installation Details (Prof)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Prof
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Profiling Instrument Readings (Prob)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Prob
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3>Time Related Remarks (Trem)
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Trem
			</xsl:attribute>All Holes
		</a>
	</h3>
...
<div id ="fieldTesting">
	...
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Dprg;Ispt;Icbr
			</xsl:attribute>All Holes
			</a>
	</h2>
	...
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Ispt
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<h3>Pressuremeter Test Results, General (Prtg)
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Prtg
			</xsl:attribute>All Holes
	</a>
	</h3>
	...
	<h3>Pressuremeter Test Data (Prtd) 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Prtd
			</xsl:attribute>All Holes
			</a>
		</h3>
	...
	<h3>Pressuremeter Test Results, Individual Loops (Prtl) 
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Prtl
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<h3>Pumping Test (Pump) 
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Pump
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<h3>Static Cone Penetration Test (Stcn) 
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Stcn
			</xsl:attribute>All Holes
			</a>
	</h3>
...
<div id ="groundInformation">
	...
	<h3> Geology Information 
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Geol
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Core
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Detl
			</xsl:attribute>All Holes
			</a>
	</h3>
	...
	<h3> Discontinuity Information 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Disc
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3> Fracture Information 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Frac
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3> Water Strike Information 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Wstk
			</xsl:attribute>All Holes
		</a>
	</h3>
	...
	<h3> Weathering Information 
		<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host_view"/><xsl:value-of select="$table"/>&amp;tables=Weth
			</xsl:attribute>All Holes
		</a>
	</h3>
