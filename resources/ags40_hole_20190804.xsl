...
<html>
  ...
  <body onload="loadSVGL()">
   <h2>Hole Summary 
		...
		<img width="140" height="115" alt="logo" src="logo.png"/>
		</div>
  </h2>
...
<div id ="holeInformation"> 
	...
	<table id="Hole">
		...
		<td>
				<xsl:element name="a">
					<xsl:if test="string-length(HoleLat)>0 and string-length(HoleLong)>0">
					<xsl:attribute name="href">
						http://www.google.com/maps/place/
						<xsl:value-of select="HoleLat"/>,
						<xsl:value-of select="HoleLong"/>
					</xsl:attribute>
					</xsl:if>
					<xsl:if test="string-length(HoleLat)=0 and string-length(HoleLong)=0">
					<xsl:attribute name="href">
		...
		<h3><a>
			...
			</xsl:attribute>Project Information (Proj)
			</a>
		</h3>
	...
	<h3>Backfill details (Bkfl) 
			<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host"/><xsl:value-of select="$table"/>&amp;tables=Bkfl
			</xsl:attribute>All Holes
			</a>
	</h3>
		<xsl:if test="count(Bkfl)>0 or count(Geol/Bkfl)>0">
		<table>
		...
		<xsl:apply-templates select="Geol/Bkfl" />
		
		</table>
		</xsl:if>

	<h3>Casing diameter by depth (Cdia)</h3>
		<xsl:if test="count(Cdia)>0 or count(Geol/Cdia)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Cdia" />
		</table>
		</xsl:if>
		
	<h3>Chiselling details (Chis)</h3>
		<xsl:if test="count(Chis)>0 or count(Geol/Chis)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Chis" />
		</table>
		</xsl:if>		

	<h3>Drilling Information (Drem) </h3>
		<xsl:if test="count(Drem)>0 or count(Geol/Drem)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Drem" />
		</table>
		</xsl:if>		

	<h3>Rotary Core Flush Details (Flsh) </h3>
		<xsl:if test="count(Flsh)>0 or count(Geol/Flsh)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Flsh" />
		</table>
		</xsl:if>	

	<h3>Hole diameter by depth (Hdia)</h3>
		<xsl:if test="count(Hdia)>0 or count(Geol/Hdia)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Hdia" />
		</table>
		</xsl:if>	

	<h3>Depth related hole information (Hdph)</h3>
		<xsl:if test="count(Hdph)>0 or count(Geol/Hdph)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Hdph" />
		</table>
		</xsl:if>
		
	<h3>Hole progress by time (Ptim)</h3>
		<xsl:if test="count(Ptim)>0 or count(Geol/Ptim)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Ptim" />
		</table>
		</xsl:if>
</div>
<div id ="laboratoryTesting">	
	...
	<h3>California Bearing Test General (Cbrg)</h3>
		<xsl:if test="count(Cbrg)>0 or count(Geol/Cbrg)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Cbrg" />
		</table>
		</xsl:if>
	<h3>California Bearing Test (Cbrt)</h3>
		<xsl:if test="count(Cbrt)>0 or count(Geol/Cbrt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Cbrt" />
		</table>
		</xsl:if>
		
	<h3>Chalk Tests (Chlk)</h3>
		<xsl:if test="count(Chlk)>0 or count(Geol/Chlk)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Chlk" />
		</table>
		</xsl:if>	
		
	<h3>Classification Tests (Clss)</h3>
		<xsl:if test="count(Clss)>0 or count(Geol/Clss)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Clss" />
		</table>
		</xsl:if>
		
	<h3>Compactions Tests General (Cmpg)</h3>
		<xsl:if test="count(Cmpg)>0 or count(Geol/Cmpg)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Cmpg" />
		</table>
		</xsl:if>	

	<h3>Compactions Tests (Cmpt)</h3>
		<xsl:if test="count(Cmpt)>0 or count(Geol/Cmpt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Cmpt" />
		</table>
		</xsl:if>	

	<h3>Contaminant and Chemical Testing (Cnmt)</h3>
		<xsl:if test="count(Cnmt)>0 or count(Geol/Cnmt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<th>Client/laboratory preferred name of determinand ()</th>
		<xsl:apply-templates select="Cmpt" />
		<xsl:apply-templates select="Geol/Cnmt" />
		</table>
		</xsl:if>
		
	<h3>Consolidation Test - General (Cong)</h3>
		<xsl:if test="count(Cong)>0 or count(Geol/Cong)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Cong" />
		</table>
		</xsl:if>
		
	<h3>Consolidation Test (Cont)</h3>
		<xsl:if test="count(Cont)>0 or count(Geol/Cont)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Cont" />
		</table>
		</xsl:if>

	<h3>Frost Susceptibility (Frst)</h3>
		<xsl:if test="count(Frst)>0 or count(Geol/Frst)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Frst" />
		</table>
		</xsl:if>

	<h3>Particle Size Distribution Analysis Data (Grad)</h3>
		<xsl:if test="count(Grad)>0 or count(Geol/Grad)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Grad" />
		</table>
		</xsl:if>	

	<h3>Moisture Condition Value (MCV)  Test General (Mcvg)</h3>
		<xsl:if test="count(Mcvg)>0 or count(Geol/Mcvg)>0">
		<table Id="Mcvg">
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Mcvg" />
		</table>
		</xsl:if>
		
	<h3>Moisture Condition Value (MCV) Test (Mcvt)</h3>
		<xsl:if test="count(Mcvt)>0 or count(Geol/Mcvt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Mcvt" />
		</table>
		</xsl:if>

	<h3>Laboratory Permeability Tests (Ptst)</h3>
		<xsl:if test="count(Ptst)>0 or count(Geol/Ptst)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Ptst" />
		</table>
		</xsl:if>

	<h3>Relative Density Test (Reld)</h3>
		<xsl:if test="count(Reld)>0 or count(Geol/Reld)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Reld" />
		</table>
		</xsl:if>

	<h3>Rock Sample Tests (Rock)</h3>
		<xsl:if test="count(Rock)>0 or count(Geol/Rock)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Rock" />
		</table>
		</xsl:if>	
		

	<h3>Shear Box Testing - General (Shbg)</h3>
		<xsl:if test="count(Shbg)>0 or count(Geol/Shbg)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Shbg" />
		</table>
		</xsl:if>
		

	<h3>Shear Box Testing (Shbt)</h3>
		<xsl:if test="count(Shbt)>0 or count(Geol/Shbt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Shbt" />
		</table>
		</xsl:if>	

	<h3>Suction Testing (Suct)</h3>
		<xsl:if test="count(Suct)>0 or count(Geol/Suct)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Suct" />
		</table>
		</xsl:if>
		
	<h3>Ten Per Cent Fines (Tnpc)</h3>
		<xsl:if test="count(Tnpc)>0 or count(Geol/Tnpc)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Tnpc" />
		</table>
		</xsl:if>

	<h3>Triaxial Test General (Trig)</h3>
		<xsl:if test="count(Trig)>0 or count(Geol/Trig)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Trig" />
		</table>
		</xsl:if>

	<h3>Triaxial Test (Trix)</h3>
		<xsl:if test="count(Trix)>0 or count(Geol/Trix)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Trix" />
		</table>
		</xsl:if>
</div>
<div id ="monitoring">
	...
	<h3>Single point instrument installation details (Inst)</h3>
		<xsl:if test="count(Inst)>0 or count(Geol/Inst)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Inst" />
		</table>
		</xsl:if>
		
	<h3>Single point instrument readings (Iobs)</h3>
		<xsl:if test="count(Iobs)>0 or count(Geol/Iobs)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to reference level of instrument from HOLE_GL or HOLE_LOCZ (m)</th>
		<th>Instrument reference number ()</th>
		...
		<xsl:apply-templates select="Geol/Iobs" />
		</table>
		</xsl:if>
		
	<h3>Monitoring Point (Monp)</h3>
		<xsl:if test="count(Monp)>0 or count(Geol/Monp)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Monp" />
		</table>
		</xsl:if>
		
	<h3>In Situ Contaminant and Chemical Testing (Icct)</h3>
		<xsl:if test="count(Icct)>0 or count(Geol/Icct)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<th>Associated file reference ()</th>
		<xsl:apply-templates select="Icct" />
		<xsl:apply-templates select="Geol/Icct" />
		</table>
		</xsl:if>
		
	<h3>Monitoring Reading (Monr)</h3>
		<xsl:if test="count(Monr)>0 or count(Geol/Monr)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Distance of monitoring point from HOLE_ID (m)</th>
		<th>Monitoring Point identifier ()</th>
		...
		<th>Associated file reference ()</th>
		<xsl:apply-templates select="Monr" />
		<xsl:apply-templates select="Geol/Monr" />
		</table>
		</xsl:if>
		
	<h3>Piezometer Installation Details (Pref)</h3>
		<xsl:if test="count(Pref)>0 or count(Geol/Pref)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Pref"/>
		</table>
		</xsl:if>
		
	<h3>Piezometer Readings (Pobs)</h3>
		<xsl:if test="count(Pobs)>0 or count(Geol/Pobs)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth to reference level of piezometer tip (m)</th>
		...
		<xsl:apply-templates select="Geol/Pobs" />
		</table>
		</xsl:if>	
		
	<h3>Profiling Instrument Installation Details (Prof)</h3>
		<xsl:if test="count(Prof)>0 or count(Geol/Prof)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Instrument reference number ()</th>
		<th>Date of reading (dd/mm/yyyy)</th>
		...
		<xsl:apply-templates select="Geol/Prof" />
		</table>
		</xsl:if>

	<h3>Profiling Instrument Readings (Prob)</h3>
		<xsl:if test="count(Prob)>0 or count(Geol/Prob)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Prob" />
		</table>
		</xsl:if>
		
	<h3>Time Related Remarks (Trem)</h3>
		<xsl:if test="count(Trem)>0 or count(Geol/Trem)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Trem" />
		</table>
		</xsl:if>
</div>
<div id ="fieldTesting">
	...
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
			<xsl:value-of select="$host"/><xsl:value-of select="$table"/>&amp;tables=Dprg;Ispt;Icbr
			</xsl:attribute>All Holes
			</a>
	</h2>
	<h3>Dynamic Probe Test - General (Dprg) </h3>
		<xsl:if test="count(Dprg)>0 or count(Geol/Dprg)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Dprg" />
		</table>
		</xsl:if>

	<h3>Dynamic Probe Test(Dprb) </h3>
		<xsl:if test="count(Dprb)>0 or count(Geol/Dprb)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Dprb" />
		</table>
		</xsl:if>

	<h3>Insitu CBR Test (Icbr) </h3>
		<xsl:if test="count(Icbr)>0 or count(Geol/Icbr)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Icbr" />
		</table>
		</xsl:if>

	<h3>Insitu Density Test (Iden) </h3>
		<xsl:if test="count(Iden)>0 or count(Geol/Iden)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Iden" />
		</table>
		</xsl:if>

	<h3>On Site Volatile Headspace Tetsing Using Flame Ionisation Detector (Ifid) </h3>
		<xsl:if test="count(Ifid)>0 or count(Geol/Ifid)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<th>Stratum reference shown on trial pit or traverse sketch ()</th>
			...
			<xsl:apply-templates select="Geol/Ifid" />
		</table>
		</xsl:if>

	<h3>On Site Volatile Headspace Testing by Photo Ionisation Detector (Ipid) </h3>
		<xsl:if test="count(Ipid)>0 or count(Geol/Ipid)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Depth of headspace test sample (m)</th>
		<th>Test number ()</th>
		...
		<xsl:apply-templates select="Geol/Ipid" />
		</table>
		</xsl:if>
	...
	<h3>Insitu Redox Test (Irdx) </h3>
		<xsl:if test="count(Irdx)>0 or count(Geol/Irdx)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Irdx" />
		</table>
		</xsl:if>

	<h3>Insitu Resestivity Test (Ires) </h3>
		<xsl:if test="count(Ires)>0 or count(Geol/Ires)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Ires" />
		</table>
		</xsl:if>	

	<h3>Insitu Vane Test (Ivan) </h3>
		<xsl:if test="count(Ivan)>0 or count(Geol/Ivan)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Ivan" />
		</table>
		</xsl:if>		

	<h3>Standard Penetration Test Results (Ispt) 
	<a>
			<xsl:attribute name="href"><!-- create the href attribute -->
		...
		<xsl:if test="count(Ispt)>0 or count(Geol/Ispt)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Ispt" />
		</table>
		</xsl:if>	

	<h3>Pressuremeter Test Results, General (Prtg) </h3>
		<xsl:if test="count(Prtg)>0 or count(Geol/Prtg)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Prtg" />
		</table>
		</xsl:if>

	<h3>Pressuremeter Test Data (Prtd) </h3>
		<xsl:if test="count(Prtd)>0 or count(Geol/Prtd)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Reference no of test ()</th>
		<th>Depth of test (m)</th>
		...
		<xsl:apply-templates select="Geol/Prtd" />
		</table>
		</xsl:if>	

	<h3>Pressuremeter Test Results, Individual Loops (Prtl) </h3>
		<xsl:if test="count(Prtl)>0 or count(Geol/Prtl)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Reference no of test ()</th>
		<th>Depth of test (m)</th>
		...
		<xsl:apply-templates select="Geol/Prtl" />
		</table>
		</xsl:if>		

	<h3>Pumping Test (Pump) </h3>
		<xsl:if test="count(Pump)>0 or count(Geol/Pump)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		<th>Date of reading (dd/mm/yyyy)</th>
		...
		<xsl:apply-templates select="Geol/Pump" />
		</table>
		</xsl:if>

	<h3>Static Cone Penetration Test (Stcn) </h3>
		<xsl:if test="count(Stcn)>0 or count(Geol/Stcn)>0">
		<table>
		<th>Exploratory hole or location equivalent ()</th>
		...
		<xsl:apply-templates select="Geol/Stcn" />
		</table>
		</xsl:if>
</div>
<div id ="groundInformation">
	...
	<h3>Core Information </h3>
		<xsl:if test="count(Core)>0 or count(Geol/Core)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Core" />
		</table>
		</xsl:if>

	<h3> Detail Information </h3>
		<xsl:if test="count(Detl)>0 or count(Geol/Detl)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Detl" />
		</table>
	</xsl:if>

	<h3> Discontinuity Information </h3>
		<xsl:if test="count(Disc)>0 or count(Geol/Disc)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Disc" />
		</table>
	</xsl:if>

	<h3> Fracture Information </h3>
		<xsl:if test="count(Frac)>0 or count(Geol/Frac)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Frac" />
		</table>
		</xsl:if>

	<h3> Water Strike Information </h3>
		<xsl:if test="count(Wstk)>0 or count(Geol/Wstk)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Wstk" />
		</table>
		</xsl:if>

	<h3> Weathering Information </h3>
		<xsl:if test="count(Weth)>0 or count(Geol/Weth)>0">
		<table>
			<th>Exploratory hole or location equivalent ()</th>
			...
			<xsl:apply-templates select="Geol/Weth" />
		</table>
		</xsl:if>
</div>
</xsl:template>
