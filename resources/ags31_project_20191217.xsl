...
<body>
	...
	<xsl:apply-templates select="/DataStructureAGSML/Proj | 
								 /DataStructureAGSML/Projects/Proj | 
								 /DataStructureAGSML/SiteInvestigation/projects/Proj |
								 /Proj | 
								 /agsml/Proj"/>
</body>
</html>
...
<th>HoleId</th>
<th>Max Depth (m)</th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Geol</xsl:attribute>Strata (Geol)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Detl</xsl:attribute>Stratum detail descriptions (Detl)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Samp</xsl:attribute>Samples(Samp)</a></th>
<xsl:apply-templates select="Hole | holes/Hole">
...
<table>
<th>HoleId</th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Bkfl</xsl:attribute>Backfill details (Bkfl)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Core</xsl:attribute>Rotary core information (Core)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Cdia</xsl:attribute>Casing diameter by depth (Cdia)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Chis</xsl:attribute>Chiselling details (Chis)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Dobs</xsl:attribute>Drilling observations (Dobs)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Drem</xsl:attribute>Drilling remarks (Drem)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Flsh</xsl:attribute>Rotary core flush (Flsh)</a></th>
<xsl:apply-templates select="Hole | holes/Hole">
...
<table>
<th>HoleId</th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Ispt</xsl:attribute>Standard Penetration Tests (Ispt)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Dprg</xsl:attribute>Dynamic Probe Tests General (count)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Dprb</xsl:attribute>Dynamic Probe Test (count)</a></th>
<xsl:apply-templates select="Hole | holes/Hole">
...
<table>
<th>HoleId</th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Cbrg</xsl:attribute>California Bearing Ratio General (Cbrg)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Cbrt</xsl:attribute>California Bearing Ratio Test(Cbrt)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Cong</xsl:attribute>Consolidation test general (Cong)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Cont</xsl:attribute>Consolidation test (Cont)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Trig</xsl:attribute>Triaxial general (Trig)</a></th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Trix</xsl:attribute>Triaxial (Trix)</a></th>
<xsl:apply-templates select="Hole | holes/Hole">
...
<table>
<th>HoleId</th>
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Clss</xsl:attribute>Classification(Clss)</a></th>
<xsl:apply-templates select="Hole | holes/Hole">
...
<tr>
<td><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$hole" />&amp;holes=<xsl:value-of select="HoleId" /></xsl:attribute><xsl:value-of select="HoleId" /></a></td>
...
<td><xsl:value-of select="count(Geol/Trix)" /></td>
</tr>
</xsl:if>
