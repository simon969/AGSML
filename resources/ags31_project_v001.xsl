...
<body>
	<xsl:comment>
		content generated by xml stylesheet ags31_project_v001
...
<th><a><xsl:attribute name="href"><xsl:value-of select="$host_view" /><xsl:value-of select="$table" />&amp;tables=Detl</xsl:attribute>Details (Detl)</a></th>
