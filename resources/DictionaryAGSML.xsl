...
<html>
  ...
  <body>
  <h2><a onclick="toggleVisible('AGS3.0')">AGS Data Dictionary AGS 3.0</a></h2>
  <h2><a onclick="toggleVisible('AGS3.1')">AGS Data Dictionary AGS 3.1</a></h2>
