...
<xsl:param name="url_loca" />
  <xsl:template match="/">
    <html>
      ...
      <body>
        <xsl:comment>
			content generated by stylesheet: ags40_table_v001.xsl
        ...
        <xsl:if test="contains($tables, 'Bkfl')">
          ...
          <table>
            ...
            <xsl:apply-templates select="Hole | agsmlDocument/Hole | DataStructureAGSML/Proj/Hole | agsml/dbo.ge_data/Proj/Hole | agsml/dbo.ge_data/Hole" >
    ...
    <xsl:if test="contains($holetables,$fortable)">
      <xsl:if test="contains($fortable,'Bkfl')">
        <xsl:apply-templates select="Bkfl">
		  <xsl:with-param name="HoleId" select="HoleId" />
  ...
  <xsl:template match="Geol">
    ...
    <xsl:if test="contains($fortable, 'Geol')">
      <tr>
        <td>
    ...
    <xsl:if test="contains($geoltables, $fortable)">
      ...
      <xsl:if test="contains($fortable, 'Eres')">
