...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <html>
      ...
      <body>
        <xsl:comment>
			...
			version:<xsl:value-of select="$version" /></xsl:comment>
  ...
  <xsl:template match="Geol">
    ...
    <xsl:if test="$fortable='Geol'">
      <tr>
        ...
        <td>
          <xsl:value-of select="$HoleNatE" />
        </td>
        <td>
          <xsl:value-of select="$HoleNatN" />
        </td>
        <td>
          <xsl:value-of select="$HoleGL" />
        </td>
        <td>
          <xsl:value-of select="GeolTop" />
        </td>
        <td>
          <xsl:value-of select="GeolBase" />
        </td>
        <td>
          <xsl:value-of select="GeolDesc" />
        </td>
        <td>
          <xsl:value-of select="GeolLeg" />
        </td>
        <td>
          <xsl:value-of select="GeolGeol" />
        </td>
        <td>
          <xsl:value-of select="GeolGeo2" />
        </td>
        <td>
          <xsl:value-of select="GeolStat" />
        </td>
        <td>
          <xsl:value-of select="FileFSet" />
        </td>
      </tr>
    </xsl:if>
    <xsl:if test="contains($geoltables, $fortable)">
  ...
  <xsl:template match="Bkfl">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="BkflTop" />
      </td>
      <td>
        <xsl:value-of select="BkflBase" />
      </td>
      <td>
        <xsl:value-of select="BkflLeg" />
      </td>
      <td>
        <xsl:value-of select="BkflDate" />
      </td>
      <td>
        <xsl:value-of select="BkflRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Cbrg">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="SampTop" />
      </td>
      <td>
        <xsl:value-of select="SampRef" />
      </td>
      <td>
        <xsl:value-of select="SampType" />
      </td>
      <td>
        <xsl:value-of select="SpecRef" />
      </td>
      <td>
        <xsl:value-of select="SpecDpth" />
      </td>
      <td>
        <xsl:value-of select="CbrgCond" />
      </td>
      <td>
        <xsl:value-of select="CbrgMeth" />
      </td>
      <td>
        <xsl:value-of select="CbrgRem" />
      </td>
      <td>
        <xsl:value-of select="CbrgNMC" />
      </td>
      <td>
        <xsl:value-of select="CbrgIMC" />
      </td>
      <td>
        <xsl:value-of select="Cbrg200" />
      </td>
      <td>
        <xsl:value-of select="CbrgSwel" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Cbrt">
    <tr>
      ...
      <td>
        <xsl:value-of select="CbrtTesn" />
      </td>
      <td>
        <xsl:value-of select="CbrtTop" />
      </td>
      <td>
        <xsl:value-of select="CbrtBot" />
      </td>
      <td>
        <xsl:value-of select="CbrtMct" />
      </td>
      <td>
        <xsl:value-of select="CbrtMcbt" />
      </td>
      <td>
        <xsl:value-of select="CbrtBDen" />
      </td>
      <td>
        <xsl:value-of select="CbrtDDen" />
      </td>
      <td>
        <xsl:value-of select="CbrtSwel" />
      </td>
      <td>
        <xsl:value-of select="CbrtRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Cdia">
    <tr>
      ...
      <td>
        <xsl:value-of select="CdiaCdep" />
      </td>
      <td>
        <xsl:value-of select="CdiaHole" />
      </td>
      <td>
        <xsl:value-of select="CdiaRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Chis">
    <tr>
      ...
      <td>
        <xsl:value-of select="ChisFrom" />
      </td>
      <td>
        <xsl:value-of select="ChisTo" />
      </td>
      <td>
        <xsl:value-of select="ChisTime" />
      </td>
      <td>
        <xsl:value-of select="ChisTool" />
      </td>
      <td>
        <xsl:value-of select="ChisRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Chlk">
    <tr>
      ...
      <td>
        <xsl:value-of select="ChlkTesn" />
      </td>
      <td>
        <xsl:value-of select="ChlkCcv" />
      </td>
      <td>
        <xsl:value-of select="ChlkMc" />
      </td>
      <td>
        <xsl:value-of select="ChlkSmc" />
      </td>
      <td>
        <xsl:value-of select="Chlk010" />
      </td>
      <td>
        <xsl:value-of select="ChlkRem" />
      </td>
      <td>
        <xsl:value-of select="ChlkCarb" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Clss">
    <tr>
      ...
      <td>
        <xsl:value-of select="ClssNMC" />
      </td>
      <td>
        <xsl:value-of select="ClssLL" />
      </td>
      <td>
        <xsl:value-of select="ClssPl" />
      </td>
      <td>
        <xsl:value-of select="ClssBDen" />
      </td>
      <td>
        <xsl:value-of select="ClssDDen" />
      </td>
      <td>
        <xsl:value-of select="ClssPD" />
      </td>
      <td>
        <xsl:value-of select="Clss425" />
      </td>
      <td>
        <xsl:value-of select="ClssPrep" />
      </td>
      <td>
        <xsl:value-of select="ClssSLim" />
      </td>
      <td>
        <xsl:value-of select="ClssLS" />
      </td>
      <td>
        <xsl:value-of select="ClssHVP" />
      </td>
      <td>
        <xsl:value-of select="ClssHVR" />
      </td>
      <td>
        <xsl:value-of select="ClssPPen" />
      </td>
      <td>
        <xsl:value-of select="ClssVnPk" />
      </td>
      <td>
        <xsl:value-of select="ClssVnRm" />
      </td>
      <td>
        <xsl:value-of select="ClssRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Cmpg">
    <tr>
      ...
      <td>
        <xsl:value-of select="CmpgType" />
      </td>
      <td>
        <xsl:value-of select="CmpgMold" />
      </td>
      <td>
        <xsl:value-of select="CMPG375" />
      </td>
      <td>
        <xsl:value-of select="Cmpg200" />
      </td>
      <td>
        <xsl:value-of select="CmpgPden" />
      </td>
      <td>
        <xsl:value-of select="CmpgMaxD" />
      </td>
      <td>
        <xsl:value-of select="CmpgMCop" />
      </td>
      <td>
        <xsl:value-of select="CmpgRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Cmpt">
    <tr>
      ...
      <td>
        <xsl:value-of select="CmpgTesn" />
      </td>
      <td>
        <xsl:value-of select="CmptMC" />
      </td>
      <td>
        <xsl:value-of select="CmptDDen" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Cnmt">
    <tr>
      ...
      <td>
        <xsl:value-of select="CnmtType" />
      </td>
      <td>
        <xsl:value-of select="Cnmt_Ttyp" />
      </td>
      <td>
        <xsl:value-of select="Cnmt_Resl" />
      </td>
      <td>
        <xsl:value-of select="CnmtUnit" />
      </td>
      <td>
        <xsl:value-of select="CnmtCAS" />
      </td>
      <td>
        <xsl:value-of select="CnmtMeth" />
      </td>
      <td>
        <xsl:value-of select="CnmtPrep" />
      </td>
      <td>
        <xsl:value-of select="CnmtRem" />
      </td>
      <td>
        <xsl:value-of select="CnmtLim" />
      </td>
      <td>
        <xsl:value-of select="CnmtName" />
      </td>
      <td>
        <xsl:value-of select="CnmtLab" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Cong">
    <tr>
      ...
      <td>
        <xsl:value-of select="CongType" />
      </td>
      <td>
        <xsl:value-of select="CongCond" />
      </td>
      <td>
        <xsl:value-of select="CongRem" />
      </td>
      <td>
        <xsl:value-of select="CongIncM" />
      </td>
      <td>
        <xsl:value-of select="CongIncD" />
      </td>
      <td>
        <xsl:value-of select="CongDia" />
      </td>
      <td>
        <xsl:value-of select="CongHigt" />
      </td>
      <td>
        <xsl:value-of select="CongMCI" />
      </td>
      <td>
        <xsl:value-of select="CongMCF" />
      </td>
      <td>
        <xsl:value-of select="CongBDen" />
      </td>
      <td>
        <xsl:value-of select="CongDDen" />
      </td>
      <td>
        <xsl:value-of select="CongPDen" />
      </td>
      <td>
        <xsl:value-of select="CongSatr" />
      </td>
      <td>
        <xsl:value-of select="CongSprs" />
      </td>
      <td>
        <xsl:value-of select="CongSath" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
      <td>
        <xsl:value-of select="CongIvr" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Cons">
    <tr>
      ...
      <td>
        <xsl:value-of select="ConsIncn" />
      </td>
      <td>
        <xsl:value-of select="ConsIvr" />
      </td>
      <td>
        <xsl:value-of select="ConsIncf" />
      </td>
      <td>
        <xsl:value-of select="ConsInce" />
      </td>
      <td>
        <xsl:value-of select="ConsInMv" />
      </td>
      <td>
        <xsl:value-of select="ConsInCv" />
      </td>
      <td>
        <xsl:value-of select="ConsInSc" />
      </td>
      <td>
        <xsl:value-of select="ConsCvRt" />
      </td>
      <td>
        <xsl:value-of select="CongCvLg" />
      </td>
      <td>
        <xsl:value-of select="ConsRem" />
      </td>
      <td>
        <xsl:value-of select="ConsCC" />
      </td>
      <td>
        <xsl:value-of select="ConsCS" />
      </td>
      <td>
        <xsl:value-of select="ConsPOP" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Core">
    <tr>
      ...
      <td>
        <xsl:value-of select="CoreTop" />
      </td>
      <td>
        <xsl:value-of select="CoreBot" />
      </td>
      <td>
        <xsl:value-of select="CorePrec" />
      </td>
      <td>
        <xsl:value-of select="CoreSrec" />
      </td>
      <td>
        <xsl:value-of select="CoreRqd" />
      </td>
      <td>
        <xsl:value-of select="CoreRem" />
      </td>
      <td>
        <xsl:value-of select="CoreDiam" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Detl">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="DetlTop" />
      </td>
      <td>
        <xsl:value-of select="DetlBase" />
      </td>
      <td>
  ...
  <xsl:template match="Disc">
    <tr>
      ...
      <td>
        <xsl:value-of select="DiscTop" />
      </td>
      <td>
        <xsl:value-of select="DiscBase" />
      </td>
      <td>
        <xsl:value-of select="FracSet" />
      </td>
      <td>
        <xsl:value-of select="DiscNumb" />
      </td>
      <td>
        <xsl:value-of select="DiscType" />
      </td>
      <td>
        <xsl:value-of select="DiscDip" />
      </td>
      <td>
        <xsl:value-of select="DiscDir" />
      </td>
      <td>
        <xsl:value-of select="DiscRgh" />
      </td>
      <td>
        <xsl:value-of select="DiscPlan" />
      </td>
      <td>
        <xsl:value-of select="DiscWave" />
      </td>
      <td>
        <xsl:value-of select="DiscAmp" />
      </td>
      <td>
        <xsl:value-of select="DiscJRC" />
      </td>
      <td>
        <xsl:value-of select="DiscApp" />
      </td>
      <td>
        <xsl:value-of select="DiscApt" />
      </td>
      <td>
        <xsl:value-of select="DiscApOb" />
      </td>
      <td>
        <xsl:value-of select="DiscInfM" />
      </td>
      <td>
        <xsl:value-of select="DiscTerm" />
      </td>
      <td>
        <xsl:value-of select="DiscPers" />
      </td>
      <td>
        <xsl:value-of select="DiscStr" />
      </td>
      <td>
        <xsl:value-of select="DiscWeth" />
      </td>
      <td>
        <xsl:value-of select="DiscSeep" />
      </td>
      <td>
        <xsl:value-of select="DiscFlow" />
      </td>
      <td>
        <xsl:value-of select="DiscRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Drem">
    <tr>
      ...
      <td>
        <xsl:value-of select="DremDpth" />
      </td>
      <td>
        <xsl:value-of select="DremBDep" />
      </td>
      <td>
        <xsl:value-of select="DremRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Dprb">
    <tr>
      ...
      <td>
        <xsl:value-of select="DprbDpth" />
      </td>
      <td>
        <xsl:value-of select="DprbBlow" />
      </td>
      <td>
        <xsl:value-of select="DprbTorq" />
      </td>
      <td>
        <xsl:value-of select="DprbDel" />
      </td>
      <td>
        <xsl:value-of select="DprbInc" />
      </td>
      <td>
        <xsl:value-of select="DprbRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Dprg">
    <tr>
      ...
      <td>
        <xsl:value-of select="DprgType" />
      </td>
      <td>
        <xsl:value-of select="DprgTest" />
      </td>
      <td>
        <xsl:value-of select="DprgMass" />
      </td>
      <td>
        <xsl:value-of select="DprgDrop" />
      </td>
      <td>
        <xsl:value-of select="DprgCone" />
      </td>
      <td>
        <xsl:value-of select="DprgRod" />
      </td>
      <td>
        <xsl:value-of select="DprgDamp" />
      </td>
      <td>
        <xsl:value-of select="DprgTip" />
      </td>
      <td>
        <xsl:value-of select="DprgRem" />
      </td>
      <td>
        <xsl:value-of select="DprgAng" />
      </td>
      <td>
        <xsl:value-of select="DprgRMss" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Flsh">
    <tr>
      ...
      <td>
        <xsl:value-of select="FlshFrom" />
      </td>
      <td>
        <xsl:value-of select="FlshTo" />
      </td>
      <td>
        <xsl:value-of select="FlshType" />
      </td>
      <td>
        <xsl:value-of select="FlshRetn" />
      </td>
      <td>
        <xsl:value-of select="FlshCol" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Frac">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="FracTop" />
      </td>
      <td>
        <xsl:value-of select="FracBase" />
      </td>
      <td>
        <xsl:value-of select="FracSet" />
      </td>
      <td>
        <xsl:value-of select="FracFi" />
      </td>
      <td>
        <xsl:value-of select="FracIMax" />
      </td>
      <td>
        <xsl:value-of select="FracIAve" />
      </td>
      <td>
        <xsl:value-of select="FracIMin" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Frst">
    <tr>
      ...
      <td>
        <xsl:value-of select="FrstCond" />
      </td>
      <td>
        <xsl:value-of select="FrstRem" />
      </td>
      <td>
        <xsl:value-of select="FrstDDen" />
      </td>
      <td>
        <xsl:value-of select="FrstMC" />
      </td>
      <td>
        <xsl:value-of select="FrstHve1" />
      </td>
      <td>
        <xsl:value-of select="FrstHve2" />
      </td>
      <td>
        <xsl:value-of select="FrstHve3" />
      </td>
      <td>
        <xsl:value-of select="FrstHve" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Grad">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="GradSize" />
      </td>
      <td>
        <xsl:value-of select="GradPerP" />
      </td>
      <td>
  ...
  <xsl:template match="Hdia">
    <tr>
      ...
      <td>
        <xsl:value-of select="HDiaHDep" />
      </td>
      <td>
        <xsl:value-of select="HDiaHole" />
      </td>
      <td>
        <xsl:value-of select="HDiaRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Hdph">
    <tr>
      ...
      <td>
        <xsl:value-of select="HDphTop" />
      </td>
      <td>
        <xsl:value-of select="HDphBase" />
      </td>
      <td>
        <xsl:value-of select="HoleType" />
      </td>
      <td>
        <xsl:value-of select="HDphStar" />
      </td>
      <td>
        <xsl:value-of select="HDphStat" />
      </td>
      <td>
        <xsl:value-of select="HDphEndD" />
      </td>
      <td>
        <xsl:value-of select="HDphEndT" />
      </td>
      <td>
        <xsl:value-of select="HDphCrew" />
      </td>
      <td>
        <xsl:value-of select="HDphLog" />
      </td>
      <td>
        <xsl:value-of select="HDphExc" />
      </td>
      <td>
        <xsl:value-of select="HDphShor" />
      </td>
      <td>
        <xsl:value-of select="HDphRem" />
      </td>
      <td>
        <xsl:value-of select="FileFSet" />
      </td>
  ...
  <xsl:template match="Icbr">
    <tr>
      ...
      <td>
        <xsl:value-of select="IcbrDpth" />
      </td>
      <td>
        <xsl:value-of select="IcbrTesN" />
      </td>
      <td>
        <xsl:value-of select="IcbrRem" />
      </td>
      <td>
        <xsl:value-of select="IcbrIcbr" />
      </td>
      <td>
        <xsl:value-of select="IcbrDate" />
      </td>
      <td>
        <xsl:value-of select="IcbrSeat" />
      </td>
      <td>
        <xsl:value-of select="IcbrSurc" />
      </td>
      <td>
        <xsl:value-of select="IcbrType" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Icct">
    <tr>
      ...
      <td>
        <xsl:value-of select="MonpDis" />
      </td>
      <td>
        <xsl:value-of select="MonpId" />
      </td>
      <td>
        <xsl:value-of select="IcctDateTime" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="CnmtType" />
      ...
      <td>
        <xsl:value-of select="CnmtTType" />
      </td>
      <td>
        <xsl:value-of select="IcctResl" />
      </td>
      <td>
        <xsl:value-of select="IcctUnit" />
      </td>
      <td>
        <xsl:value-of select="IcctMeth" />
      </td>
      <td>
        <xsl:value-of select="IcctCas" />
      </td>
      <td>
        <xsl:value-of select="IcctPrep" />
      </td>
      <td>
        <xsl:value-of select="IcctRem" />
      </td>
      <td>
        <xsl:value-of select="IcctLim" />
      </td>
      <td>
        <xsl:value-of select="IcctULim" />
      </td>
      <td>
        <xsl:value-of select="IcctName" />
      </td>
      <td>
        <xsl:value-of select="IcctLab" />
      </td>
      <td>
        <xsl:value-of select="IcctCred" />
      </td>
      <td>
        <xsl:value-of select="IcctLbId" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Iden">
    <tr>
      ...
      <td>
        <xsl:value-of select="IdenDpth" />
      </td>
      <td>
        <xsl:value-of select="IdenTesN" />
      </td>
      <td>
        <xsl:value-of select="IdenDate" />
      </td>
      <td>
        <xsl:value-of select="IdenRem" />
      </td>
      <td>
        <xsl:value-of select="IdenIDen" />
      </td>
      <td>
        <xsl:value-of select="IdenMC" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Ifid">
    <tr>
      ...
      <td>
        <xsl:value-of select="IfidDpth" />
      </td>
      <td>
        <xsl:value-of select="IfIdTesN" />
      </td>
      <td>
        <xsl:value-of select="IfIdDate" />
      </td>
      <td>
        <xsl:value-of select="IfIdRem" />
      </td>
      <td>
        <xsl:value-of select="IfIdRes" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Inst">
    <tr>
      ...
      <td>
        <xsl:value-of select="InstDip" />
      </td>
      <td>
        <xsl:value-of select="InstDir" />
      </td>
      <td>
        <xsl:value-of select="InstIntz" />
      </td>
      <td>
        <xsl:value-of select="IdenRem" />
      </td>
  ...
  <xsl:template match="Iobs">
    <tr>
      ...
      <td>
        <xsl:value-of select="IObsDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="IObsPres" />
      </td>
      <td>
        <xsl:value-of select="IObsLevl" />
      </td>
      <td>
        <xsl:value-of select="IObsRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Ipid">
    <tr>
      ...
      <td>
        <xsl:value-of select="IpidDpth" />
      </td>
      <td>
        <xsl:value-of select="IpIdTesN" />
      </td>
      <td>
        <xsl:value-of select="IpIdDate" />
      </td>
      <td>
        <xsl:value-of select="IpIdRem" />
      </td>
      <td>
        <xsl:value-of select="IpIdRes" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Iprm">
    <tr>
      ...
      <td>
        <xsl:value-of select="IprmTop" />
      </td>
      <td>
        <xsl:value-of select="IprmBase" />
      </td>
      <td>
        <xsl:value-of select="IprmStg" />
      </td>
      <td>
        <xsl:value-of select="IprmTesN" />
      </td>
      <td>
        <xsl:value-of select="IprmType" />
      </td>
      <td>
        <xsl:value-of select="IprmPrwl" />
      </td>
      <td>
        <xsl:value-of select="IprmSwal" />
      </td>
      <td>
        <xsl:value-of select="IprmTDia" />
      </td>
      <td>
        <xsl:value-of select="IprmSDia" />
      </td>
      <td>
        <xsl:value-of select="IprmIprm" />
      </td>
      <td>
        <xsl:value-of select="IprmRem" />
      </td>
      <td>
        <xsl:value-of select="IprmFlow" />
      </td>
      <td>
        <xsl:value-of select="IprmAwl" />
      </td>
      <td>
        <xsl:value-of select="IprmHead" />
      </td>
      <td>
        <xsl:value-of select="IprmDate" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Irdx">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="IrdxDpth" />
      </td>
      <td>
        <xsl:value-of select="IrdxTesN" />
      </td>
      <td>
        <xsl:value-of select="IrdxDate" />
      </td>
      <td>
        <xsl:value-of select="IrdxRem" />
      </td>
      <td>
        <xsl:value-of select="IrdxPh" />
      </td>
      <td>
        <xsl:value-of select="IrdxIrdx" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Ires">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="IresDpth" />
      </td>
      <td>
        <xsl:value-of select="IresTesN" />
      </td>
      <td>
        <xsl:value-of select="IresDate" />
      </td>
      <td>
        <xsl:value-of select="IresIres" />
      </td>
      <td>
        <xsl:value-of select="IresRem" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Ispt">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="IsptTop" />
      </td>
      <td>
        <xsl:value-of select="IsptSeat" />
      </td>
      <td>
        <xsl:value-of select="IsptMain" />
      </td>
      <td>
        <xsl:value-of select="IsptNpen" />
      </td>
      <td>
        <xsl:value-of select="IsptNval" />
      </td>
      <td>
        <xsl:value-of select="IsptRep" />
      </td>
      <td>
        <xsl:value-of select="IsptCas" />
      </td>
      <td>
        <xsl:value-of select="IsptWat" />
      </td>
      <td>
        <xsl:value-of select="IsptType" />
      </td>
      <td>
        <xsl:value-of select="IsptSwp" />
      </td>
      <td>
        <xsl:value-of select="IsptInc1" />
      </td>
      <td>
        <xsl:value-of select="IsptInc2" />
      </td>
      <td>
        <xsl:value-of select="IsptInc3" />
      </td>
      <td>
        <xsl:value-of select="IsptInc4" />
      </td>
      <td>
        <xsl:value-of select="IsptInc5" />
      </td>
      <td>
        <xsl:value-of select="IsptInc6" />
      </td>
      <td>
        <xsl:value-of select="IsptPen1" />
      </td>
      <td>
        <xsl:value-of select="IsptPen2" />
      </td>
      <td>
        <xsl:value-of select="IsptPen3" />
      </td>
      <td>
        <xsl:value-of select="IsptPen4" />
      </td>
      <td>
        <xsl:value-of select="IsptPen5" />
      </td>
      <td>
        <xsl:value-of select="IsptPen6" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Ivan">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="IvanDpth" />
      </td>
      <td>
        <xsl:value-of select="IvanTesN" />
      </td>
      <td>
        <xsl:value-of select="IvanRem" />
      </td>
      <td>
        <xsl:value-of select="IvanIvan" />
      </td>
      <td>
        <xsl:value-of select="IvanIvar" />
      </td>
      <td>
        <xsl:value-of select="IvanIPen" />
      </td>
      <td>
        <xsl:value-of select="IvanDate" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Mcvg">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="McvgRem" />
      </td>
      <td>
        <xsl:value-of select="Mcvg200" />
      </td>
      <td>
        <xsl:value-of select="McvgNMC" />
      </td>
      <td>
        <xsl:value-of select="McvgPrcl" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Mcvt">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="McvtTesN" />
      </td>
      <td>
        <xsl:value-of select="McvtMC" />
      </td>
      <td>
        <xsl:value-of select="McvtRelK" />
      </td>
      <td>
        <xsl:value-of select="McvtBDen" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Monp">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="MonpDate" />
      </td>
      <td>
        <xsl:value-of select="MonpType" />
      </td>
      <td>
        <xsl:value-of select="MonpTrz" />
      </td>
      <td>
        <xsl:value-of select="MonpBrz" />
      </td>
      <td>
        <xsl:value-of select="MonpBrgA" />
      </td>
      <td>
        <xsl:value-of select="MonpBrgB" />
      </td>
      <td>
        <xsl:value-of select="MonpBrgC" />
      </td>
      <td>
        <xsl:value-of select="MonpIncA" />
      </td>
      <td>
        <xsl:value-of select="MonpIncB" />
      </td>
      <td>
        <xsl:value-of select="MonpIncC" />
      </td>
      <td>
        <xsl:comment>
          <xsl:value-of select="MonpRSCA" />
        </xsl:comment>
      </td>
      <td>
        <xsl:value-of select="MonpRSCB" />
      </td>
      <td>
        <xsl:value-of select="MonpRSCC" />
      </td>
      <td>
        <xsl:value-of select="MonpRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Monr">
    ...
    <tr>
      ...
      <td></td>
      <td>
        <xsl:value-of select="MonrDstA" />
      </td>
      <td>
        <xsl:value-of select="MonrDstB" />
      </td>
      <td>
        <xsl:value-of select="MonrDspA" />
      </td>
      <td>
        <xsl:value-of select="MonrDspB" />
      </td>
      <td>
        <xsl:value-of select="MonrDspC" />
      </td>
      <td>
        <xsl:value-of select="MonrPres" />
      </td>
      <td>
        <xsl:value-of select="MonrAngA" />
      </td>
      <td>
        <xsl:value-of select="MonrAngB" />
      </td>
      <td>
        <xsl:value-of select="MonrAngC" />
      </td>
      <td>
        <xsl:value-of select="MonrSTRA" />
      </td>
      <td>
        <xsl:value-of select="MonrStrB" />
      </td>
      <td>
        <xsl:value-of select="MonrStrC" />
      </td>
      <td>
        <xsl:value-of select="MonrForc" />
      </td>
      <td>
        <xsl:value-of select="MonrTemp" />
      </td>
      <td>
      ...
      <td>
        <xsl:value-of select="MonpEast" />
      </td>
      <td>
        <xsl:value-of select="MonpNrth" />
      </td>
      <td>
        <xsl:value-of select="MonpLev" />
      </td>
      <td>
        <xsl:value-of select="MonpWhd" />
      </td>
      <td>
        <xsl:value-of select="MonpGuag" />
      </td>
      <td>
        <xsl:value-of select="MonpFlow" />
      </td>
      <td>
        <xsl:value-of select="MonrRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Pobs">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PrefTDep" />
      </td>
      <td>
        <xsl:value-of select="PObsDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="PObsDep" />
      </td>
      <td>
        <xsl:value-of select="PObsHead" />
      </td>
      <td>
        <xsl:value-of select="PObsRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Pref">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PrefDate" />
      </td>
      <td>
        <xsl:value-of select="PrefType" />
      </td>
      <td>
        <xsl:value-of select="PrefTrps" />
      </td>
      <td>
        <xsl:value-of select="PrefBrps" />
      </td>
      <td>
        <xsl:value-of select="PrefRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Prob">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="ProbDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="ProbDep" />
      </td>
      <td>
        <xsl:value-of select="PrObGuag" />
      </td>
      <td>
        <xsl:value-of select="PrObTDep" />
      </td>
      <td>
        <xsl:value-of select="PrObBDep" />
      </td>
      <td>
        <xsl:value-of select="ProbA" />
      </td>
      <td>
        <xsl:value-of select="ProbB" />
      </td>
      <td>
        <xsl:value-of select="ProbC" />
      </td>
      <td>
        <xsl:value-of select="ProbD" />
      </td>
      <td>
        <xsl:value-of select="ProbRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Prof">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="ProfDate" />
      </td>
      <td>
        <xsl:value-of select="ProfType" />
      </td>
      <td>
        <xsl:value-of select="ProfTrps" />
      </td>
      <td>
        <xsl:value-of select="ProfBrps" />
      </td>
      <td>
        <xsl:value-of select="ProfDirA" />
      </td>
      <td>
        <xsl:value-of select="ProfRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Proj">
    <tr>
      ...
      <td>
        <xsl:value-of select="GintRecID" />
      </td>
      <td>
        <xsl:value-of select="gINTProjId" />
      </td>
      <td>
        <xsl:value-of select="ProjName" />
      </td>
      <td>
        <xsl:value-of select="ProjClnt" />
      </td>
      <td>
        <xsl:value-of select="ProjCont" />
      </td>
      <td>
        <xsl:value-of select="projEng" />
      </td>
      <td>
        <xsl:value-of select="projDate" />
      </td>
      <td>
        <xsl:value-of select="projAGS" />
      </td>
      <td>
        <xsl:value-of select="projMemo" />
      </td>
      <td>
        <xsl:value-of select="projCid" />
      </td>
      <td>
        <xsl:value-of select="projProd" />
      </td>
      <td>
        <xsl:value-of select="projDatm" />
      </td>
      <td>
        <xsl:value-of select="projGrid" />
      </td>
      <td>
        <xsl:value-of select="projPage" />
      </td>
      <td>
        <xsl:value-of select="projRecv" />
      </td>
      <td>
        <xsl:value-of select="projIsno" />
      </td>
      <td>
        <xsl:value-of select="projStat" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
      <td>
        <xsl:value-of select="projLoc" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Prtd">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PrtdTRef" />
      </td>
      <td>
        <xsl:value-of select="PrtdDpth" />
      </td>
      <td>
        <xsl:value-of select="PrtdSeq" />
      </td>
      <td>
        <xsl:value-of select="PrtdDate" />
      </td>
      <td>
        <xsl:value-of select="PrtdType" />
      </td>
      <td>
        <xsl:value-of select="PrtdDia" />
      </td>
      <td>
        <xsl:value-of select="PrtdArm1" />
      </td>
      <td>
        <xsl:value-of select="PrtdArm2" />
      </td>
      <td>
        <xsl:value-of select="PrtdArm3" />
      </td>
      <td>
        <xsl:value-of select="PrtdTpc1" />
      </td>
      <td>
        <xsl:value-of select="PrtdTpc2" />
      </td>
      <td>
        <xsl:value-of select="PrtdTpc3" />
      </td>
      <td>
        <xsl:value-of select="PrtdPpA" />
      </td>
      <td>
        <xsl:value-of select="PrtdPpB" />
      </td>
      <td>
        <xsl:value-of select="PrtdRem" />
      </td>
      <td>
        <xsl:value-of select="PrtdPres" />
      </td>
      <td>
        <xsl:value-of select="PrtdVol" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Prtg">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PrtgTRef" />
      </td>
      <td>
        <xsl:value-of select="PrtgDpth" />
      </td>
      <td>
        <xsl:value-of select="PrtgDate" />
      </td>
      <td>
        <xsl:value-of select="PrtgType" />
      </td>
      <td>
        <xsl:value-of select="PrtgDia" />
      </td>
      <td>
        <xsl:value-of select="PrtgHA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgHA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgHA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgHAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgGIA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgGIA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgGIA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgGIAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgCUA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgCUA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgCUA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgCUAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgPLA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgPLA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgPLA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgPLAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgAFA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgAFA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgAFA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgAFAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgADA1" />
      </td>
      <td>
        <xsl:value-of select="PrtgADA2" />
      </td>
      <td>
        <xsl:value-of select="PrtgADA3" />
      </td>
      <td>
        <xsl:value-of select="PrtgADAA" />
      </td>
      <td>
        <xsl:value-of select="PrtgAFCV" />
      </td>
      <td>
        <xsl:value-of select="PrtgRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Prtl">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PrtlTRef" />
      </td>
      <td>
        <xsl:value-of select="PrtlDpth" />
      </td>
      <td>
        <xsl:value-of select="PrtlDate" />
      </td>
      <td>
        <xsl:value-of select="PrtlLNo" />
      </td>
      <td>
        <xsl:value-of select="PrtlType" />
      </td>
      <td>
        <xsl:value-of select="PrtlDia" />
      </td>
      <td>
        <xsl:value-of select="PrtlGA1" />
      </td>
      <td>
        <xsl:value-of select="PrtlGA2" />
      </td>
      <td>
        <xsl:value-of select="PrtlGA3" />
      </td>
      <td>
        <xsl:value-of select="PrtlGAA" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Ptim">
    <tr>
      ...
      <td>
        <xsl:value-of select="PtimDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="PtimDep" />
      </td>
      <td>
        <xsl:value-of select="PtimCas" />
      </td>
      <td>
        <xsl:value-of select="PtimWat" />
      </td>
      <td>
        <xsl:value-of select="PtimRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Ptst">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PtstTesN" />
      </td>
      <td>
        <xsl:value-of select="PtstRem" />
      </td>
      <td>
        <xsl:value-of select="PtstCond" />
      </td>
      <td>
        <xsl:value-of select="PtstSzun" />
      </td>
      <td>
        <xsl:value-of select="PtstDia" />
      </td>
      <td>
        <xsl:value-of select="PtstLen" />
      </td>
      <td>
        <xsl:value-of select="PtstMC" />
      </td>
      <td>
        <xsl:value-of select="PtstBDen" />
      </td>
      <td>
        <xsl:value-of select="PtstDDen" />
      </td>
      <td>
        <xsl:value-of select="PtstVoid" />
      </td>
      <td>
        <xsl:value-of select="PtstK" />
      </td>
      <td>
        <xsl:value-of select="PtstTstr" />
      </td>
      <td>
        <xsl:value-of select="PtstIsat" />
      </td>
      <td>
        <xsl:value-of select="PtstFsat" />
      </td>
      <td>
        <xsl:value-of select="PtstPDen" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Pump">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="PumpDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="PumpDpth" />
      </td>
      <td>
        <xsl:value-of select="PumpQuat" />
      </td>
      <td>
        <xsl:value-of select="PumpRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Reld">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="ReldRem" />
      </td>
      <td>
        <xsl:value-of select="ReldDMax" />
      </td>
      <td>
        <xsl:value-of select="Reld375" />
      </td>
      <td>
        <xsl:value-of select="Reld063" />
      </td>
      <td>
        <xsl:value-of select="Reld020" />
      </td>
      <td>
        <xsl:value-of select="ReldDMin" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Rock">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="RockPls" />
      </td>
      <td>
        <xsl:value-of select="RockPlsi" />
      </td>
      <td>
        <xsl:value-of select="RockPltf" />
      </td>
      <td>
        <xsl:value-of select="RockUcs" />
      </td>
      <td>
        <xsl:value-of select="RockRem" />
      </td>
      <td>
        <xsl:value-of select="RockPrem" />
      </td>
      <td>
        <xsl:value-of select="RockUrem" />
      </td>
      <td>
        <xsl:value-of select="RockE" />
      </td>
      <td>
        <xsl:value-of select="RockMu" />
      </td>
      <td>
        <xsl:value-of select="RockBraz" />
      </td>
      <td>
        <xsl:value-of select="RockPoro" />
      </td>
      <td>
        <xsl:value-of select="RockPore" />
      </td>
      <td>
        <xsl:value-of select="RockMc" />
      </td>
      <td>
        <xsl:value-of select="RockBden" />
      </td>
      <td>
        <xsl:value-of select="RockDden" />
      </td>
      <td>
        <xsl:value-of select="RockPden" />
      </td>
      <td>
        <xsl:value-of select="RockDrem" />
      </td>
      <td>
        <xsl:value-of select="RockWtab" />
      </td>
      <td>
        <xsl:value-of select="RockWrem" />
      </td>
      <td>
        <xsl:value-of select="RockSdi" />
      </td>
      <td>
        <xsl:value-of select="RockSrem" />
      </td>
      <td>
        <xsl:value-of select="RockSoun" />
      </td>
      <td>
        <xsl:value-of select="RockMrem" />
      </td>
      <td>
        <xsl:value-of select="RockAcv" />
      </td>
      <td>
        <xsl:value-of select="RockCrem" />
      </td>
      <td>
        <xsl:value-of select="RockAiv" />
      </td>
      <td>
        <xsl:value-of select="RockIrem" />
      </td>
      <td>
        <xsl:value-of select="RockLosa" />
      </td>
      <td>
        <xsl:value-of select="RockLrem" />
      </td>
      <td>
        <xsl:value-of select="RockAav" />
      </td>
      <td>
        <xsl:value-of select="RockPsv" />
      </td>
      <td>
        <xsl:value-of select="RockFi" />
      </td>
      <td>
        <xsl:value-of select="RockEi" />
      </td>
      <td>
        <xsl:value-of select="ROCK_DESC" />
      </td>
      <td>
        <xsl:value-of select="RockShor" />
      </td>
      <td>
        <xsl:value-of select="RockPwav" />
      </td>
      <td>
        <xsl:value-of select="RockSwav" />
      </td>
      <td>
        <xsl:value-of select="RockEmod" />
      </td>
      <td>
        <xsl:value-of select="RockSg" />
      </td>
      <td>
        <xsl:value-of select="RockSwel" />
      </td>
      <td>
        <xsl:value-of select="FileFSet" />
      </td>
  ...
  <xsl:template match="Samp">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="SampDia" />
      </td>
      <td>
        <xsl:value-of select="SampDesc" />
      </td>
      <td>
        <xsl:value-of select="SampUblo" />
      </td>
      <td>
        <xsl:value-of select="SampRem" />
      </td>
      <td>
        <xsl:value-of select="SampDate" />
      </td>
      <td>
        <xsl:value-of select="SampTime" />
      </td>
      <td>
        <xsl:value-of select="SampBar" />
      </td>
      <td>
        <xsl:value-of select="SampWDep" />
      </td>
      <td>
        <xsl:value-of select="SampTemp" />
      </td>
      <td>
        <xsl:value-of select="SampPres" />
      </td>
      <td>
        <xsl:value-of select="SampFlow" />
      </td>
      <td>
        <xsl:value-of select="SampPrep" />
      </td>
      <td>
        <xsl:value-of select="GeolStat" />
      </td>
  ...
  <xsl:template match="Shbg">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="ShbgType" />
      </td>
      <td>
        <xsl:value-of select="ShbgRem" />
      </td>
      <td>
        <xsl:value-of select="ShpgPCoh" />
      </td>
      <td>
        <xsl:value-of select="ShpgPhi" />
      </td>
      <td>
        <xsl:value-of select="ShpgRCoh" />
      </td>
      <td>
        <xsl:value-of select="ShpgRPhi" />
      </td>
      <td>
        <xsl:value-of select="FileFSet" />
      </td>
  ...
  <xsl:template match="Shbt">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="SHBTTesN" />
      </td>
      <td>
        <xsl:value-of select="ShbtBDen" />
      </td>
      <td>
        <xsl:value-of select="ShbtDDen" />
      </td>
      <td>
        <xsl:value-of select="ShbtNorm" />
      </td>
      <td>
        <xsl:value-of select="ShbtDisp" />
      </td>
      <td>
        <xsl:value-of select="ShbtPeak" />
      </td>
      <td>
        <xsl:value-of select="ShbtRes" />
      </td>
      <td>
        <xsl:value-of select="ShbtPDis" />
      </td>
      <td>
        <xsl:value-of select="ShbtRDis" />
      </td>
      <td>
        <xsl:value-of select="ShbtPDen" />
      </td>
      <td>
        <xsl:value-of select="ShbtIvr" />
      </td>
      <td>
        <xsl:value-of select="ShbtMCI" />
      </td>
      <td>
        <xsl:value-of select="ShbtMCF" />
      </td>
      <td>
        <xsl:value-of select="ShbtRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Stcn">
    <tr>
      ...
      <td>
        <xsl:value-of select="StcnDpth" />
      </td>
      <td>
        <xsl:value-of select="StcnType" />
      </td>
      <td>
        <xsl:value-of select="StcnRef" />
      </td>
      <td>
        <xsl:value-of select="StcnRes" />
      </td>
      <td>
        <xsl:value-of select="StcnFres" />
      </td>
      <td>
        <xsl:value-of select="StcnPwp1" />
      </td>
      <td>
        <xsl:value-of select="StcnPwp2" />
      </td>
      <td>
        <xsl:value-of select="StcnPwp3" />
      </td>
      <td>
        <xsl:value-of select="StcnCon" />
      </td>
      <td>
        <xsl:value-of select="StcnTemp" />
      </td>
      <td>
        <xsl:value-of select="StcnPh" />
      </td>
      <td>
        <xsl:value-of select="StcnSlp1" />
      </td>
      <td>
        <xsl:value-of select="StcnSlp2" />
      </td>
      <td>
        <xsl:value-of select="StcnRedx" />
      </td>
      <td>
        <xsl:value-of select="StcnFfd" />
      </td>
      <td>
        <xsl:value-of select="StcnPMT" />
      </td>
      <td>
        <xsl:value-of select="StcnPid" />
      </td>
      <td>
        <xsl:value-of select="StcnFid" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Suct">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="SuctMeth" />
      </td>
      <td>
        <xsl:value-of select="SuctVal" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Tncp">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="TnpcTesN" />
      </td>
      <td>
        <xsl:value-of select="TnpcRem" />
      </td>
      <td>
        <xsl:value-of select="TnpcDry" />
      </td>
      <td>
        <xsl:value-of select="TnpcWet" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Trem">
    <tr>
      ...
      <td>
        <xsl:value-of select="TremDate" />
      </td>
      <td></td>
      <td>
        <xsl:value-of select="TremRem" />
      </td>
      <td>
        <xsl:value-of select="FileFset" />
      </td>
  ...
  <xsl:template match="Trig">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="TrigType" />
      </td>
      <td>
        <xsl:value-of select="TrigCond" />
      </td>
      <td>
        <xsl:value-of select="TrigCu" />
      </td>
      <td>
        <xsl:value-of select="TrigCoh" />
      </td>
      <td>
        <xsl:value-of select="TrigPhi" />
      </td>
      <td>
        <xsl:value-of select="FileFSet" />
      </td>
  ...
  <xsl:template match="Trix">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="TrixTesn" />
      </td>
      <td>
        <xsl:value-of select="TrixSDia" />
      </td>
      <td>
        <xsl:value-of select="TrixMC" />
      </td>
      <td>
        <xsl:value-of select="TrixCell" />
      </td>
      <td>
        <xsl:value-of select="TrixDevF" />
      </td>
      <td>
        <xsl:value-of select="TrixSLen" />
      </td>
      <td>
        <xsl:value-of select="TrixBDen" />
      </td>
      <td>
        <xsl:value-of select="TrixDDen" />
      </td>
      <td>
        <xsl:value-of select="TrixPwPF" />
      </td>
      <td>
        <xsl:value-of select="TrixPwPI" />
      </td>
      <td>
        <xsl:value-of select="TrixCu" />
      </td>
      <td>
        <xsl:value-of select="TrixStrn" />
      </td>
      <td>
        <xsl:value-of select="TrixMode" />
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Weth">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="WethTop" />
      </td>
      <td>
        <xsl:value-of select="WethBase" />
      </td>
      <td>
        <xsl:value-of select="WethGrad" />
      </td>
      <td>
        <xsl:value-of select="WethRem" />
      </td>
    </tr>
  </xsl:template>
  <xsl:template match="Wstk">
    ...
    <tr>
      ...
      <td>
        <xsl:value-of select="WStkDep" />
      </td>
      <td>
        <xsl:value-of select="WStkNMin" />
      </td>
      <td>
        <xsl:value-of select="WStkCas" />
      </td>
      <td>
        <xsl:value-of select="WStkDate" />
      </td>
      <td>
        <xsl:value-of select="WStkTime" />
      </td>
      <td>
        <xsl:value-of select="WStk_Post" />
      </td>
      <td>
        <xsl:value-of select="WStkFlow" />
      </td>
      <td>
        <xsl:value-of select="WStkSeal" />
      </td>
    </tr>
  </xsl:template>
</xsl:stylesheet>