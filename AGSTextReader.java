...
public class AGSTextReader {
    private static final Logger log = Logger.getLogger( AGSTextReader.class.getName() );
    private int m_i;
    private int m_eoh;
    ...
    private String const_strCRLF;
    private String const_TableIdentifier;
    private String const_HeaderIdentifier;
    ...
    public AGSTextReader(){
        }
    public AGSTextReader(String str){
    ...
    const_strCRLFQ = "\r\"\n";
    const_strCRLF = "\r\n";
    const_TableIdentifier = "**";
    const_HeaderIdentifier = "*";
