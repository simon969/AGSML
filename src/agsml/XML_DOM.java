...
public XML_DOM(String xmlFileName,fileState var ){
   try {
       ...
       File xmlFile = new File (xmlFileName);
            ...
            if (!xmlFile.exists() && var == fileState.CREATEIFNOTEXIST) {
                NewFile();
            } 
            
            if (!xmlFile.exists() && var == fileState.MUSTEXIST) {
               throw new FileNotFoundException("Could not find file: " + xmlFileName);
            } 
