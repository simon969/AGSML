 ...
 *
   ...
   public static void test5(){
         ...
         AGSMLConverter ac = new AGSMLConverter();
...
public static void test16(){
   ...
   agsd.convert_n1("ags");
   agsd.convert_n2("agsml");
   agsd.find_table1("**CLSS");
   agsd.find_field1("*CLSS_425");
   String s1 = agsd.field2_name();
   System.out.print(s1);
}
